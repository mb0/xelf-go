...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{`1`, &Lit{typ.Num, lit.Int(1), src(0, 1)}},
		...
		{`(int 1)`, call(src(0, 7),
			...
			&Lit{typ.Num, lit.Int(1), src(5, 6)},
		)},
		{`(bool 1)`, call(src(0, 8),
			&Sym{Sym: "bool", Src: src(1, 5)},
			&Lit{typ.Num, lit.Int(1), src(6, 7)},
		)},
		...
		{`('Hello ' $Name '!')`, call(src(0, 20),
			&Lit{typ.Char, lit.Str("Hello "), src(1, 9)},
			&Sym{Sym: "$Name", Src: src(10, 15)},
			&Lit{typ.Char, lit.Str("!"), src(16, 19)},
		)},
		{`(a b; d)`, call(src(0, 8),
		...
		{`((1 2) 1 2)`, call(src(0, 11),
			call(src(1, 6),
				&Lit{typ.Num, lit.Int(1), src(2, 3)},
				&Lit{typ.Num, lit.Int(2), src(4, 5)},
			),
			&Lit{typ.Num, lit.Int(1), src(7, 8)},
			&Lit{typ.Num, lit.Int(2), src(9, 10)},
		)},
		{`(1 z:(3 4))`, call(src(0, 11),
			&Lit{typ.Num, lit.Int(1), src(1, 2)},
			&Tag{Tag: "z", Src: src(3, 10), Exp: call(src(5, 10),
				&Lit{typ.Num, lit.Int(3), src(6, 7)},
				&Lit{typ.Num, lit.Int(4), src(8, 9)},
			)},
		)},
