...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{`()`, &Call{Src: src(0, 2)}},
		{`<>`, &Lit{lit.Wrap(&typ.Void, typ.VarTyp), src(0, 2)}},
		{`(() 1 2 3 'things')`, &Call{Src: src(0, 19)}},
		{`(<> 1 2 3 'things')`, &Call{Src: src(0, 19)}},
		{`null`, &Lit{lit.Null{}, src(0, 4)}},
		{`1`, &Lit{lit.Num(1), src(0, 1)}},
		{`1.0`, &Lit{lit.Real(1), src(0, 3)}},
		{`bool`, &Sym{Sym: "bool", Src: src(0, 4)}},
		{`name`, &Sym{Sym: "name", Src: src(0, 4)}},
		{`(false)`, call(src(0, 7),
			&Lit{lit.Bool(false), src(1, 6)},
		)},
		{`(int 1)`, call(src(0, 7),
			&Sym{Sym: "int", Src: src(1, 4)},
			&Lit{lit.Num(1), src(5, 6)},
		)},
		{`(bool 1)`, call(src(0, 8),
			&Sym{Sym: "bool", Src: src(1, 5)},
			&Lit{lit.Num(1), src(6, 7)},
		)},
		{`(bool (() comment) 1)`, call(src(0, 21),
			&Sym{Sym: "bool", Src: src(1, 5)},
			&Lit{lit.Num(1), src(19, 20)},
		)},
		{`<obj x:int y:int>`, &Lit{lit.Wrap(typ.Obj("",
			typ.P("x", typ.Int),
			typ.P("y", typ.Int),
		).Mut(), typ.VarTyp), src(0, 17)}},
		{`('Hello ' $Name '!')`, call(src(0, 20),
			&Lit{lit.Char("Hello "), src(1, 9)},
			&Sym{Sym: "$Name", Src: src(10, 15)},
			&Lit{lit.Char("!"), src(16, 19)},
		)},
		{`(a b; d)`, call(src(0, 8),
		...
		{`((1 2) 1 2)`, call(src(0, 11),
			call(src(1, 6),
				&Lit{lit.Num(1), src(2, 3)},
				&Lit{lit.Num(2), src(4, 5)},
			),
			&Lit{lit.Num(1), src(7, 8)},
			&Lit{lit.Num(2), src(9, 10)},
		)},
		{`(1 z:(3 4))`, call(src(0, 11),
			&Lit{lit.Num(1), src(1, 2)},
			&Tag{Tag: "z", Src: src(3, 10), Exp: call(src(5, 10),
				&Lit{lit.Num(3), src(6, 7)},
				&Lit{lit.Num(4), src(8, 9)},
			)},
		)},
		...
		{`1 2`, call(ast.Src{},
			...
			&Lit{lit.Num(1), src(0, 1)},
			&Lit{lit.Num(2), src(2, 3)},
		)},
	}
